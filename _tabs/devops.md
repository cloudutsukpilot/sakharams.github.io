...
<div class="card categories">
    ...
    >
    <span>
        <img alt="Cloud" src="/assets/img/icons/cloud/cloud-18.svg" />
    ...
    <div class="container d-flex flex-wrap align-items-top">
        ...
        <div class="p-2">
            <img alt="Microsoft Azure" src="/assets/img/icons/cloud/azure/azure-18.svg" />
        ...
        <div class="p-2">
            ...
            src="/assets/img/icons/cloud/gcp/googlecloudplatform-18.svg"
            />
...
<div class="card categories">
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Docker" src="/assets/img/icons/devops/orchestration/docker-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Kubernetes" src="/assets/img/icons/devops/orchestration/kuberentes-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Cloud Formation" src="/assets/img/icons/devops/orchestration/awscloudformation-18.svg" />
            <a
        ...
        <div class="p-2">
            ...
            src="/assets/img/icons/devops/orchestration/azureresourcemanager-18.svg"
            />
            <a
        ...
        <div class="p-2">
            <img alt="Helm" src="/assets/img/icons/devops/orchestration/helm-18.svg" />
            <a
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="Terraform" src="/assets/img/icons/devops/orchestration/terraform-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Cloudify" src="/assets/img/icons/devops/orchestration/cloudify-18.jpeg" />
            <a
        ...
        <div class="p-2">
            <img alt="Morpheus" src="/assets/img/icons/devops/orchestration/morpheus-18.svg" />
            <a
...
<div class="card categories">
    ...
    <span>
        ...
        src="/assets/img/icons/devops/configurationmanagement/configuration-management-18.svg"
        />
        <a
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Powershell" src="/assets/img/icons/devops/configurationmanagement/powershell-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Puppet" src="/assets/img/icons/devops/configurationmanagement/puppet-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Chef" src="/assets/img/icons/devops/configurationmanagement/chef-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Saltstack" src="/assets/img/icons/devops/configurationmanagement/saltstack-18.svg" />
            <a
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="Ansible" src="/assets/img/icons/devops/configurationmanagement/redhatansible-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Vagrant" src="/assets/img/icons/devops/configurationmanagement/vagrant-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Consul" src="/assets/img/icons/devops/configurationmanagement/consul-18.svg" />
            <a
...
<div class="card categories">
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Jenkins" src="/assets/img/icons/devops/cicd/jenkins-18.svg" />
            <a href="/posts/devops/cicd/jenkins/jenkins" class="ml-1 mr-2"
            >Jenkins</a
            >
        </div>
        <div class="p-2">
            <img alt="Gitlab" src="/assets/img/icons/devops/cicd/gitlab-18.svg" />
            <a href="/posts/devops/cicd/gitlab/gitlab" class="ml-1 mr-2"
            >GitLab</a
            >
        </div>
        <div class="p-2">
            <img alt="Azure DevOps" src="/assets/img/icons/devops/cicd/azuredevops-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="TeamCity" src="/assets/img/icons/devops/cicd/teamcity-18.svg" />
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="Bamboo" src="/assets/img/icons/devops/cicd/bamboo-18.svg" />
            <a href="/posts/devops/cicd/bamboo/bamboo" class="ml-1 mr-2"
            >Bamboo</a
            >
        </div>
        <div class="p-2">
            <img alt="TravisCI" src="/assets/img/icons/devops/cicd/travisci-18.svg" />
            <a href="/posts/devops/cicd/travisci/travisci" class="ml-1 mr-2"
            >Travis CI</a
            >
        </div>
        <div class="p-2">
            <img alt="Spinnaker" src="/assets/img/icons/devops/cicd/spinnaker-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="GitHub Actions" src="/assets/img/icons/devops/cicd/githubactions-18.svg" />
            <a
...
<div class="card categories">
    ...
    >
    <span>
        <img alt="Coding" src="/assets/img/icons/miscellaneous/coding-18.svg" />
        <a
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Terraform" src="/assets/img/icons/devops/iac/terraform-18.svg" />
            <a
            href="/posts/devops/orchestration/terraform/terraform"
            class="ml-1 mr-2"
            >Terraform</a
        ...
        <div class="p-2">
            <img alt="Azure Resource Manager"
            src="/assets/img/icons/devops/iac/azureresourcemanager-18.svg"
            />
            <a
            href="/posts/devops/orchestration/arm/azure-resource-manager"
            class="ml-1 mr-2"
        ...
        <div class="p-2">
            ...
            src="/assets/img/icons/devops/iac/awscloudformation-18.svg"
            />
            <a
            href="/posts/devops/orchestration/aws cloud formation/aws-cloud-formation"
            class="ml-1 mr-2"
...
<div class="card categories">
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Diagrams" src="/assets/img/icons/miscellaneous/diagrams.svg" />
            <a
...
<div class="card categories">
    ...
    <div class="container d-flex flex-wrap align-items-top">
        ...
        <div class="d-flex flex-column">
            <div class="p-2">
                <img alt="GitHub"
                src="/assets/img/icons/devops/cicd/github-18.svg"
                />
                <a
...
<div class="card categories">
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Prometheus" src="/assets/img/icons/devops/monitoring/prometheus-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Grafana" src="/assets/img/icons/devops/monitoring/grafana-18.svg" />
            <a
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="Loki" src="/assets/img/icons/devops/monitoring/loki-18.svg" />
            <a
        ...
        <div class="p-2">
            <img alt="Datadog" src="/assets/img/icons/devops/monitoring/datadog-18.svg" />
            <a
...
<div class="card categories">
    ...
    >
    <span>
        <img alt="Databases" src="/assets/img/icons/databases/databases-18.svg" />
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="MSSQL" src="/assets/img/icons/databases/mssql-18.svg" />
            <a
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="PostgreSQL" src="/assets/img/icons/databases/postgresql-18.svg" />
            <a
...
<div class="card categories">
    ...
    >
    <span>
        <img alt="Operating Systems" src="/assets/img/icons/operatingsystems/operatingsystem-18.svg" />
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
            <div class="p-2">
                <img alt="Windows" src="/assets/img/icons/operatingsystems/windows-18.svg" />
                <a
                ...
                <div class="p-2">
                <img alt="MacOS" src="/assets/img/icons/operatingsystems/macos-18.svg" />
                <a
        ...
        <div class="d-flex flex-column">
            <div class="p-2">
                <img alt="Linux Ubuntu" src="/assets/img/icons/operatingsystems/linuxos-18.svg" />
                <a
            ...
            <div class="p-2">
                <img alt="Linux Ubuntu" src="/assets/img/icons/operatingsystems/ubuntuos-18.svg" />
                <a
            ...
            <div class="p-2">
                <img alt="Linux Debian" src="/assets/img/icons/operatingsystems/debianos-18.svg" />
                <a
...
<div class="card categories">
    ...
    >
    <span>
        <img alt="IAM" src="/assets/img/icons/iam/awsiam/iam-18.svg" />
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Entra ID" src="/assets/img/icons/iam/entraid/azuread-18.svg" />
            <a href="/posts/iam/entraid/microsoft-entraid" class="ml-1 mr-2"
            >Azure Entra ID</a
            >
        </div>
        <div class="p-2">
            <img alt="GCP IAM" src="/assets/img/icons/iam/gcpiam/iam-18.svg" />
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="AWS IAM" src="/assets/img/icons/iam/awsiam/iam-18.svg" />
            <a href="/posts/iam/aws/aws-iam" class="ml-1 mr-2"
            >AWS IAM</a
            >
        </div>
        <div class="p-2">
            <img alt="SSO" src="/assets/img/icons/miscellaneous/sso-18.svg" />
...
<div class="card categories">
    ...
    >
    <span>
        <img alt="Virtualization" src="/assets/img/icons/virtualization/virtualization-18.svg" />
    ...
    <div class="container d-flex flex-wrap align-items-top">
        <div class="d-flex flex-column w-50">
        <div class="p-2">
            <img alt="Hyper-V" src="/assets/img/icons/virtualization/hyperv-18.svg" />
            <a
        ...
        <div class="d-flex flex-column">
        <div class="p-2">
            <img alt="VMWare" src="/assets/img/icons/virtualization/vmware-18.svg" />
            <a
