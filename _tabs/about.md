...
- `Team Size`: 8
- `Description`: 
    + Responsible for integrating security into all phases of the development and deployment lifecycle, automating security processes, and ensuring continuous monitoring and compliance within the CI/CD pipeline. |
- `Responsibilities`:	
    ...
    + Automated the journaling feature for a product from creating a docker image, terraform code for infra creation using CICD pipeline and integrated into the .NET application.
...
- `Team Size`: 10-15 
- `Description`
    + Deploy an existing application to the Microsoft Azure cloud platform using DevOps practices to take advantage of the scalability, flexibility, and cost efficiency offered by cloud technology.
- `Responsibilities` 
