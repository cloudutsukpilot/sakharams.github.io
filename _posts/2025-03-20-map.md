...
<div class="card categories">
    ...
    <div id="a_131" class="collapse" aria-expanded="false">
        <ul class="list-group">
            ...
            <li class="list-group-item">
            <i class="far fa-folder fa-fw"></i>
            <a href="/posts/cloud/azure/containers/aks/aks" class="mx-2">Azure Kubernetes Service (AKS)</a>
            <i class="far fa-folder fa-fw"></i>
            <a href="/posts/cloud/azure/containers/openshift/azure-red-hat-openshift" class="mx-2">Azure Read Hat OpenShift</a>
            </li>
        </ul>
    </div>
</div>
